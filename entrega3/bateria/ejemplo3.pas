{programa correcto - declaracion de variables, definicion de tipos incluyendo subrango y arreglo, declaracion de funcion y procedimiento, pasaje de parametros
...
function func2(var a:integer;b:tipo3):boolean;
begin
	func2:=b[2];
end;
